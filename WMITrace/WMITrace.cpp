...
ETWSession::ETWSession() : _hSession(NULL), _bStarted(FALSE) {
		...
		Properties.BufferSize = 0;															// buffer size for logging  in kbytes. 0 = Let ETW decide
		Properties.MinimumBuffers = 0;														// Lets ETW decide_MinimumBuffers;														
		Properties.MaximumBuffers = 0;														// lets ETW to decide  _MaximumBuffers;		
